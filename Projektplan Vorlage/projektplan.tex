...
\item \textbf{Gondelmodul des IPS:} zur Bestimmung der aktuellen Position des Zeppelins
\item \textbf{nRF24L01 Modul (evtl. in Gondelmodul enthalten):} zur Kommunikation mit der Basisstation am Computer
